                ...
                <tbody>
                    @foreach ($tolls as $key => $toll)
                        <tr>
                            ...
                            @can('toll-edit')
                                <td>
                                    <a href="{{ route('toll.edit', $toll->id) }}" class="btn btn-success">Update</a>
                                </td>
                            @endcan
                            @can('toll-delete')
                                <td>
                            ...
                            {{-- @can('toll-pay')
                                ...
                                @else
                                    <td>Disputed</td>
                                    <td><a class="btn btn-primary" href="{{ route('toll.pay', $toll->id) }}">Disputed</a></td>
                                @endif
                            @endcan --}}
                    @endforeach
                </tbody>
